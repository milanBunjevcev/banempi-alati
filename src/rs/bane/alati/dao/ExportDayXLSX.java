...
import static rs.bane.alati.model.ucinci.dnevni.Production.currentWorkingPricePerHour;
...
public class ExportDayXLSX {
    ...
    public static boolean exportVrednosno(ArrayList<Production> prodList, String imeFajla) {
        ...
        XSSFSheet sheet = workbook.createSheet(new SimpleDateFormat("dd").format(prodList.get(0).getDate()));
        ...
        for (Production p : prodList) {
            ...
            pageB:
            {
                ...
                if (!pretRadnik.equalsIgnoreCase(p.getWorker().getNameFull())) {
...
//
            ...
            double cenaRada = currentWorkingPricePerHour;
            ...
            if (sledeci == null || !p.getWorker().getNameFull().equals(sledeci.getWorker().getNameFull())) {
                ...
                } else if (p.getWorker().getNameFull().length() >= 18) {
